...
// NewPostProjectProjectIDNotificationsTestParamsWithHTTPClient creates a new PostProjectProjectIDNotificationsTestParams object
// with the ability to set a custom HTTPClient for a request.
func NewPostProjectProjectIDNotificationsTestParamsWithHTTPClient(client *http.Client) *PostProjectProjectIDNotificationsTestParams {
	return &PostProjectProjectIDNotificationsTestParams{
		HTTPClient: client,
	}
}
...
/*
PostProjectProjectIDNotificationsTestParams contains all the parameters to send to the API endpoint

	for the post project project ID notifications test operation.

	Typically these are written to a http.Request.
*/
type PostProjectProjectIDNotificationsTestParams struct {
...
func (o *PostProjectProjectIDNotificationsTestParams) WithDefaults() *PostProjectProjectIDNotificationsTestParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post project project ID notifications test params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostProjectProjectIDNotificationsTestParams) SetDefaults() {
