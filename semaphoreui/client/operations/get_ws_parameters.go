...
func (o *GetWsParams) WithDefaults() *GetWsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get ws params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWsParams) SetDefaults() {
