		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("semaphoreui_project_runner.test", "tags.0", "linux"),
					resource.TestCheckResourceAttr("semaphoreui_project_runner.test", "tags.1", "production"),
					...
					resource.TestCheckResourceAttrSet("semaphoreui_project_runner.test", "registration_token"),
				),
			},
			...
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("semaphoreui_project_runner.test", "tags.0", "windows"),
				),
			},
			// Delete testing
			{
